  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Gestionando y evaluando el talento humano
        p.mb-4 Reafirmar los conceptos, saberes y habilidades para aplicar procesos de personal y evaluaciones de desempeño, con base en los temas del componente formativo.
